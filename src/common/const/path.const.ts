...
// The paths to the images folders for access from the client
export const ALCOHOL_IMAGES_ACCESS_PATH = join('/', PUBLIC_FOLDER_NAME, ALCOHOLS_FOLDER_NAME, IMAGES_FOLDER_NAME);
export const REVIEW_IMAGES_ACCESS_PATH = join('/', PUBLIC_FOLDER_NAME, REVIEWS_FOLDER_NAME, IMAGES_FOLDER_NAME);
export const USER_IMAGES_ACCESS_PATH = join('/', PUBLIC_FOLDER_NAME, USERS_FOLDER_NAME, IMAGES_FOLDER_NAME);
